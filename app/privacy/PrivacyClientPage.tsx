      ...
      <section className="w-full py-4 lg:py-4 px-6 lg:px-16">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div>
            ...
            {/* ===== NEW REFUND AND POLICY SECTION START ===== */}
            <div>
              <h2 className="text-3xl font-serif font-bold text-primary mb-4">Refund Policy</h2>
              <p className="text-black-800 leading-relaxed mb-4">
                Our refund policy is structured around the unique nature of custom publishing services, where work is performed sequentially and requires upfront commitment.
              </p>
              
              <h3 className="text-xl font-semibold text-light mb-2">Project Deposit & Cancellation</h3>
              <p className="text-black-800 leading-relaxed mb-4">
                A non-refundable deposit is typically required to initiate a publishing project. This covers initial consultations, resource allocation, and project setup costs.
              </p>

              <h3 className="text-xl font-semibold text-light mb-2">Refunds for Completed Services</h3>
              <ul className="space-y-2 ml-4">
                <li className="text-black-800">
                  Refunds are generally <strong>not</strong> available for services that have been fully rendered (e.g., a completed manuscript edit, final cover design delivery, or ghostwriting phases).
                </li>
                <li className="text-black-800">
                  If you choose to terminate a project after work has commenced but before completion, you will be billed for all work completed up to the point of cancellation, and any remaining balance of your payment may be refunded.
                </li>
              </ul>
              <p className="text-black-800 leading-relaxed mt-4">
                For detailed refund terms specific to your service tier and project stage, please refer to your signed <strong>Service Agreement Contract</strong>.
              </p>
            </div>
            {/* ===== NEW REFUND AND POLICY SECTION END ===== */}
          ...
          <div>
            ...
            <div className="bg-dark-secondary rounded-lg p-6 border border-primary/20">
              <p className="text-light font-semibold mb-2">Emperor Book Publisher</p>
              <p className="text-black-800">Email: info@emperorbookpublisher.com</p>
              <p className="text-black-800">Phone: +1 305-765-7102</p>
              <p className="text-black-800">Location: ST PETERSBURG, FL 33702</p>
            </div>
          </div>
