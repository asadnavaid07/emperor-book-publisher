        ...
        <FadeIn direction="up">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <PopupForm>
                <button className="px-8 py-4 bg-gradient-to-r from-primary to-primary-teal-dark text-white font-semibold rounded-full hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 group">
                  Schedule Free Call
                  <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition" />
                </button>
              </PopupForm>
              <Link href="#process" className="px-8 py-4 bg-transparent border-2 border-primary text-primary font-semibold rounded-full hover:bg-primary/10 transition-all duration-300 hover:scale-105 active:scale-95 flex items-center justify-center">
